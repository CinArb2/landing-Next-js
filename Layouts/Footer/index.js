    ...
    <footer className={styles.footer} id="contactanos">
      ...
      <div className={styles.container}>
        <div className={styles.businessInfo}>
          ...
          <p>
            Garantizando el crecimiento sostenible de las producciones y del
            cuidado animal{' '}
          </p>
        </div>
        <div className={styles.contactList}>
          ...
          <ul className={styles.list}>
            ...
            <li>
              ...
              agrointegralsas@hotmail.com
            </li>
            <li>
              <AiFillClockCircle className={styles.icon} />
              Lunes a sábados de 8:00am a 6:00pm
            </li>
          </ul>
          <a
            href="https://www.instagram.com/agrointegral_agropecuaria/"
            target="_blank"
