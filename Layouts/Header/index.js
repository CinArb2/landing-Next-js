...
const index = () => {
  ...
  return (
     <>
      <div
        onClick={handleClose}
        className={`${styles.overlay} ${isVisible ? styles.visible : ''}`}></div>
        ...
        <div className={styles.menu}
         ...
         <nav
          ...
          <Link href="/#productos">
             <a
               onClick={handleClose}
               className={router.asPath === "/#productos"
                 ?`${styles.navLink} ${styles.active}`
                 :`${styles.navLink}`}
             >Productos</a>
          </Link>
          <Link href="/#servicios">
             <a
               onClick={handleClose}
             className={router.asPath === "/#servicios"
                 ?`${styles.navLink} ${styles.active}`
                 :`${styles.navLink}`}
             >Servicios</a>
          </Link>
          <Link href="/#contactanos">
             <a
               onClick={handleClose}
              className={router.asPath === "/#contactanos"
                 ?`${styles.navLink} ${styles.active}`
                 :`${styles.navLink}`}
             >Contactanos</a>
          </Link>
